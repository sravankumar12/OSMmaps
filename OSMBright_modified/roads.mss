...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [zoom=15] {
    ...
    [stylegroup='minorroad']{ line-width: @rdz15_min + 0.5; }
  ...
  [zoom=16] {
    ...
    [stylegroup='minorroad']{ line-width: @rdz16_min + 0.5; }
  ...
  [zoom>=17] {
    ...
    [stylegroup='minorroad']{ line-width: @rdz17_min + 0.5; }
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  [zoom=11] {
    ...
    [stylegroup='mainroad'] { line-width: @rdz11_med + 0.5; }
  ...
  [zoom=13] {
    ...
    [stylegroup='mainroad'] { line-width: @rdz13_med + 0.5; }
    [stylegroup='minorroad']{ line-width: 0; }
  ...
  [zoom=16] {
    ...
    [stylegroup='mainroad'] { line-width: @rdz16_med + 1; }
