...
#place::city[type='city'][zoom>=5][zoom<=14] {
  text-name:'[name]';
  text-face-name:@sans;
  text-placement:point;
  text-fill:@city_text;
...
#area_label {
  ...
  [zoom>=8 ][area>102400000],
  [zoom>=9 ][area>22400000],
  [zoom>=10][area>8600000],
  [zoom>=11][area>1600000],
  [zoom>=12][area>320000],
  [zoom>=13][area>100000],
  [zoom>=14][area>50000],
  [zoom>=15][area>10000],
...
/*  [railway = 'subway_entrance'][zoom >= 18] {
    point-file: url('img/symbols/walking.n.12.png');
  ...
  [railway = 'tram_stop'][zoom >= 13] {
    marker-file: url('img/metro-map.png');
...
/*  [railway = 'halt'],
  ...
  [aerialway = 'station']::aerialway {
    [zoom >= 13] {
      marker-file: url('img/symbols/square.svg');
      marker-placement: interior;
